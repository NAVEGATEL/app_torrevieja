    ...
    <div class="d-flex justify-content-around align-items-center text-light">
        ...
        <div class="d-flex align-items-center justify-content-center">
          ...
          <div class="d-flex align-items-center flex-row ">
              ...
              <div class="ms-2">
                  <p class="mb-0 footEl">C/ Cardenal Cisneros, 5 03201 Elche (Alicante)</p>
              </div>
          </div>
          ...
          <div class="d-flex align-items-center flex-row  ">
              ...
              <div class="mx-2">
                  <a href="tel:+34673660910" class="text-light ">673 66 09 10</a> 
              </div>
              -
              <div class="mx-2"> 
                  <a href="tel:+34865784466" class="text-light ">865 78 44 66</a>
              </div>
          </div>
